...
//         });
        ...
        map.getContainer().addEventListener('mousemove', function (event) {
            ...
            scene.getFeatureAt(pixel).then(function(selection) {
                ...
                popup.innerHTML += '<span class="labelInner">' + '<a target="_blank" href="' + url + '" onclick="trackOutboundLink("' + url + '", editing_unnamed_roads, iD); return false;">Edit with iD ➹</a>' + '</span><br>';
                popup.innerHTML += '<span class="labelInner">' + '<a target="_blank" href="' + josmUrl + '" onclick="trackOutboundLink("' + josmUrl + '", editing_unnamed_roads, JOSM); return false;">Edit with JOSM ➹</a>' + '</span><br>';
            });
        });
